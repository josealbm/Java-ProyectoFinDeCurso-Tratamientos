...
public class Consultas {
	...
	public static void actualiza(final Connection con) throws SQLException {
		...
		try {
			...
			pst.setString(2, lector.next());//lee lo que pasas por pantalla y lo introduce en la columna nombre que es el 2?
			System.out.print("El nuevo cp será :");
			pst.setString(1, lector.next());//lee lo que introduces por pantalla y lo introduce en la columna cp que es 1º ?
			pst.executeUpdate();
			con.commit();
